...
EXTRA_ARGS=("--faster-skip-repeat-edit-suffixes" "--no-minimize-args" "--no-try-all-inlining-and-minimization-again-at-end" "--inline-user-contrib" "-Q" "/tmp/doesnotexist/Ltac2" "Ltac2" "$@")
##########################################################
