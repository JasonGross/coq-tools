...
EXTRA_ARGS=("--faster-skip-repeat-edit-suffixes" "--no-minimize-args" "--no-try-all-inlining-and-minimization-again-at-end" "--passing-coqc" "coqc" "--passing-R" "/tmp" "YESPASSING" "--nonpassing-R" "/tmp" "NONPASSING" "--nonpassing-R" "." "Foo" "$@")
##########################################################
