...
def main():
    ...
    try:
        ...
        topname = None
        for args_name, coq_prog, passing_prefix, base_dir in (
            ("coqc_args", env["coqc"], "", env["base_dir"]),
            ("coqtop_args", env["coqtop"], "", env["base_dir"]),
            ("passing_coqc_args", env["passing_coqc"] if env["passing_coqc"] else env["coqc"], "passing_", env["passing_base_dir"]),
            ("passing_coqtop_args", env["passing_coqtop"] if env["passing_coqtop"] else env["coqtop"], "passing_", env["passing_base_dir"]),
        ):
